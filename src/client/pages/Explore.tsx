        ...
        {!teacherSignedIn && (
          <nav className="page-shell-wide relative z-20 flex flex-wrap items-center justify-between gap-4 py-5">
            ...
            <div className="hidden md:flex items-center gap-10 font-bold text-lg">
              ...
              <button onClick={() => navigate('/contact')} className="hover:text-brand-orange transition-colors">{t('explore.nav.contact')}</button>
            </div>
              ...
              {featuredPack && (
                ...
                >
                  ...
                  <div className="relative z-10">
                    <p className="text-xs font-black uppercase tracking-[0.25em] text-brand-yellow mb-3">{t('explore.featured.label')}</p>
          ...
          <section className="grid grid-cols-1 xl:grid-cols-[280px_1fr] gap-8">
            <aside className="space-y-6">
              <div className="bg-white rounded-[2.2rem] border-4 border-brand-dark shadow-[8px_8px_0px_0px_#1A1A1A] p-6 xl:sticky xl:top-24">
                ...
                <div className="mb-6">
                  <p className="text-xs font-black uppercase tracking-[0.2em] text-brand-dark/45 mb-3">{t('explore.filters.sortBy')}</p>
                ...
                <div>
                  <p className="text-xs font-black uppercase tracking-[0.2em] text-brand-dark/45 mb-3">{t('explore.filters.conceptClusters')}</p>
            ...
            <section className="space-y-6 pb-16">
              ...
              {loading ? (
                ...
                <div className="bg-white border-4 border-brand-dark rounded-[2rem] p-10 shadow-[6px_6px_0px_0px_#1A1A1A]">
                  <p className="text-2xl font-black mb-2">{t('explore.atlas.unavailable')}</p>
                ...
                <div className="bg-white border-4 border-brand-dark rounded-[2rem] p-12 shadow-[8px_8px_0px_0px_#1A1A1A] text-center">
                  <p className="text-3xl font-black mb-3">{t('explore.atlas.noMatches')}</p>
        ...
        <div className="fixed inset-0 z-40 bg-black/30 flex justify-end">
          <div className="w-full max-w-[620px] h-full bg-white border-l-4 border-brand-dark p-4 sm:p-6 overflow-y-auto shadow-[-8px_0_0_0_#1A1A1A]">
            <div className="flex items-start justify-between gap-4 mb-6">
              <div>
                <p className="text-xs font-black uppercase tracking-[0.2em] text-brand-purple mb-2">{t('explore.drawer.label')}</p>
            ...
            <div className="rounded-[1.8rem] border-2 border-brand-dark bg-brand-bg p-5 mb-6">
              <p className="text-xs font-black uppercase tracking-[0.2em] text-brand-orange mb-2">{t('explore.drawer.teachingBrief')}</p>
              <p className="font-medium text-brand-dark/75 whitespace-pre-line">{selectedPack.teaching_brief || selectedPack.source_excerpt}</p>
            </div>

            <div className="mb-6">
              <p className="text-xs font-black uppercase tracking-[0.2em] text-brand-dark/45 mb-3">{t('explore.drawer.keyPoints')}</p>
            ...
            <div className="mb-8">
              <p className="text-xs font-black uppercase tracking-[0.2em] text-brand-dark/45 mb-3">{t('explore.drawer.conceptFingerprint')}</p>
              <div className="flex flex-wrap gap-2">
    ...
    >
      <div className={`rounded-[1.8rem] border-2 border-brand-dark ${accent} p-5 mb-5`}>
        <div className={`flex items-start justify-between gap-4 mb-4 ${isRtl ? 'flex-row-reverse' : ''}`}>
          <div>
            <p className="text-xs font-black uppercase tracking-[0.2em] text-brand-dark/50 mb-2">{pack.source_language || t('explore.packCard.notAvailable')}</p>
      ...
      <div className="flex items-center justify-between gap-3">
        <span className="text-sm font-black text-brand-purple uppercase tracking-[0.14em]">{t('explore.packCard.openIntel')}</span>
